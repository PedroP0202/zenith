...
export default function Home() {
    ...
    const dateStr = mounted ? format(now, "MMM do, yyyy", { locale: enUS }) : 'Loading...';
            ...
            <div className="w-full max-w-md pt-8">
                ...
                {allActiveHabits.length === 0 ? (
                    <div className="flex flex-col items-center justify-center mt-32 text-center opacity-70">
                        <p className="text-lg mb-6">A folha está em branco.</p>
                        <Link
                            href="/habit/new"
                    ...
                    <div className="space-y-10">
                        {habitsForToday.length > 0 && (
                            <div className="space-y-4">
                                <h3 className="text-[12px] font-bold text-white/50 tracking-wider uppercase mb-4">Para Hoje</h3>
                                <AnimatePresence>
                        ...
                        {otherHabits.length > 0 && (
                            <div className="space-y-4">
                                <h3 className="text-[12px] font-bold text-white/30 tracking-wider uppercase mb-4">Outros Dias</h3>
                                <AnimatePresence>
